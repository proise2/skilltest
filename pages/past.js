...
const past = () => {
  return (
    <div className={styles.container}>
      ...
      <pb. Which (non-Vercel) technical or sales article, guide or lightning talk left the biggest positive
<b>impression</b> on you?<b>Why?</b> (and please provide the link)
</p>
